...
from config import MODEL_DIR, get_upload_model_options, logger
from db.sqlite import get_job as get_saved_job
from service.auto_annotate_service import auto_annotate_dataset_assets
from service.auto_annotate_task_service import (
...
from service.model_registry_service import (
...
from service.train_task_service import (
...
from service.result_store_service import load_result_manifest
...
def train_job_report_page(job_id: str):
    ...
    return render_template("train_report.html", report=report, job=job, model_dir=MODEL_DIR)
...
def dataset_import_results(dataset_id: str):
    ...
    source_type = "oracle_result" if (job.get("job_type") or "oracle") == "oracle" else "upload_result"
